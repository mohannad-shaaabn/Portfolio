        ...
        <div className="grid md:grid-cols-2 md:gap-24">
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              ...
              className="absolute text-xs font-second text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-tirquoize peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              Enter your name
            </label>
          </div>
